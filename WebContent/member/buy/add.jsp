...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String bookname="";String writer="";String pub="";String price="",num="",user="",state="";String time=""; 
		if(method.equals("upbuy")){
			id=request.getParameter("id");
			List alist=cb.get1Com("select * from buybook where id='"+id+"'",8);
  ...
  <tr>
    ...
    <input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" />
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <select onClick="javascript:{document.all.writer.value=this.options[this.selectedIndex].getAttribute('writer');document.all.public.value=this.options[this.selectedIndex].getAttribute('pub');document.all.bookname.value=this.options[this.selectedIndex].value;}" required>
        <%if(method.equals("upbuy")){ %>
      ...
      <input type="hidden" name="state" value="未审核">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">数量：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for"> 
        <input type="number" min="1" name="num" class="text-word" value="<%=num %>" required/>    
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
