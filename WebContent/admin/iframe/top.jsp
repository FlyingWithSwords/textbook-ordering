...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">教材<%=(sf.equals("教材发行员工"))?"销售":(sf.equals("书库采购员工")?"采购":"") %>管理系统</td>
        <td align="right" valign="top" id="header-right">
        	<a href="<%=basePath %>AdminServlet?method=adminexit" target="_top" 
        	onclick="if (confirm('确定要退出吗？')) return true; else return false;" onFocus="this.blur()" class="admin-out">注销</a>
        	<a href="<%=basePath %>admin/index.jsp" target="_top" onFocus="this.blur()" class="admin-index">刷新</a>  
            <a href=""  onFocus="this.blur()" class="admin-home">当前用户：<%=username %> </a>     	
            <span>
<!-- 日历 -->
