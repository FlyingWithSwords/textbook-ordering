...
<%  String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from user where username like '%"+word+"%' and chara!='管理员' and chara!='教师' and chara!='学生'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from user where username like '%"+word+"%' and chara!='管理员' and chara!='教师' and chara!='学生' order by id desc",6);
