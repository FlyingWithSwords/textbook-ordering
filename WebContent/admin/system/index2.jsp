...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		List alist=cb.get1Com("select * from user where username='"+username+"'",6); 
		id=alist.get(0).toString();
  ...
  <tr>
    ...
    <form class="form-x" action="<%=basePath %>AdminServlet?method=<%=method%>" method="post" name="form1">  
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" class="text-word" name="username" value="<%=username %>" required/>  
        </td>
      </tr>       
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
