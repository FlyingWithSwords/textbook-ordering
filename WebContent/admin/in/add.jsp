...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String bookname="";String writer="";String pub="";String price="",total="";String time=""; 
		if(method.equals("upin")){
			id=request.getParameter("id");
			List alist=cb.get1Com("select * from inbook where id='"+id+"'",7);
