...
<%
	...
	int cou = cb.getMessageCount("select count(*) from user where chara='教师' or chara='学生'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from user where chara='教师' or chara='学生' order by id desc",6);
