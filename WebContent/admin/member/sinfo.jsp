...
<%  String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from user where username like '%"+word+"%' and chara='教师' or chara='学生'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from user where username like '%"+word+"%' and chara='教师' or chara='学生' order by id desc",6);
    ...
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
     ...
     <td align="center" valign="middle" class="borderright borderbottom"><%=i+1 %></td>   
      ...
      <td align="center" valign="middle" class="borderbottom">
       <a onFocus="this.blur()" class="add" href="<%=basePath%>MemberServlet?method=delm&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr>  
<% }} %>  
    </table>
